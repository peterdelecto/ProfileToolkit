...
# Derived from FILAMENT_LAYOUT keys that only exist in OrcaSlicer layouts
ORCA_ONLY_TABS = {
    tab
    for tab in FILAMENT_LAYOUT
    if tab in {"Setting Overrides", "Multimaterial", "Dependencies", "Notes"}
}
...
CONVERSION_DEFAULTS: dict[str, tuple[object, str]] = {
    ...
    # BambuStudio / OrcaSlicer defaults
    "hot_plate_temp": (60, "Hot plate bed temperature — typical 60°C for PLA"),
    "hot_plate_temp_initial_layer": (
        60,
        "Hot plate first layer bed temp — typical 60°C",
    ),
    "cool_plate_temp": (55, "Cool plate bed temperature — typically 5°C lower"),
    "cool_plate_temp_initial_layer": (55, "Cool plate first layer bed temp"),
    "textured_plate_temp": (60, "Textured PEI plate bed temperature"),
    "textured_plate_temp_initial_layer": (60, "Textured PEI first layer bed temp"),
    "eng_plate_temp": (60, "Engineering plate bed temperature"),
    "eng_plate_temp_initial_layer": (60, "Engineering plate first layer bed temp"),
    "textured_cool_plate_temp": (55, "Textured cool plate bed temperature"),
    "textured_cool_plate_temp_initial_layer": (
        55,
        "Textured cool plate first layer temp",
    ),
    "supertack_plate_temp": (55, "SuperTack plate bed temperature"),
    "supertack_plate_temp_initial_layer": (55, "SuperTack plate first layer temp"),
    "close_fan_the_first_x_layers": (
        1,
        "Keep fan off for first layer — BambuStudio default",
    ),
    "slow_down_min_speed": (10, "Minimum speed when slowing down — 10 mm/s default"),
    "filament_flow_ratio": (1.0, "Flow ratio 1.0 — adjust for over/under extrusion"),
    "filament_retraction_length": (
        0.8,
        "Retraction length — 0.8mm typical for direct drive",
    ),
    "filament_retraction_speed": (30, "Retraction speed — 30mm/s typical"),
    "filament_deretraction_speed": (30, "Deretraction speed — 30mm/s typical"),
}
